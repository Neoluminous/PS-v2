...
const slides = [
  { image: "/images/hero-samvad.webp", kicker: "Dialogue that moves communities forward", titleHTML: "Change Begins<br />With <em>Samvad.</em>", titleKey: "Change Begins With Samvad.", text: "More than two decades of grassroots programmes advancing dignity, opportunity and well-being across India.", cta: "Explore our work", href: "#work", position: "center", logo: null, logoAlt: "", logoTone: "" },
  { image: "/images/hero-education.webp", kicker: "Women, girls & young people", titleHTML: "Knowledge becomes<br /><em>confidence.</em>", titleKey: "Knowledge becomes<br /><em>confidence.</em>", text: "Education, health awareness and skills that help people participate more fully in their own development.", cta: "See our programmes", href: "#work", position: "right", logo: null, logoAlt: "", logoTone: "" },
  { image: "/images/hero-youth.webp", kicker: "Creative advocacy since 2004", titleHTML: "Hard issues need<br /><em>open conversations.</em>", titleKey: "Hard issues need<br /><em>open conversations.</em>", text: "From school workshops to theatre and documentary storytelling, we create spaces where people can ask, learn and act.", cta: "Our story", href: "#journey", position: "left", logo: null, logoAlt: "", logoTone: "" },
  { image: "/images/hero-know-your-money.webp", kicker: "Financial literacy with HDFC Securities", titleHTML: "Understand money.<br /><em>Use it well.</em>", titleKey: "Understand money.<br /><em>Use it well.</em>", text: "A free five-hour programme covering saving, banking, credit, insurance and safer digital payments.", cta: "Learn more", href: "/kym", position: "right", secondary: false, logo: "/images/hero-partners/hdfc-securities.webp", logoAlt: "HDFC Securities", logoTone: "dark" },
    ...
    <section className="hero" aria-roledescription="carousel" aria-label="Punjabi Samvad highlights">
      {slides.map((slide, index) => (
        <div className={`hero-slide ${slide.position} ${active === index ? "active" : ""}`} key={index} aria-hidden={active !== index}>
          <img src={slide.image} alt="" className="hero-image" fetchPriority={index === 0 ? "high" : "auto"} loading={index === 0 ? "eager" : "lazy"} /><div className="hero-overlay" />
